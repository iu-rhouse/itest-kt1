...
from my_message_handlers import HandlerForMessageFromWebSocket, MessageHandlerCopyToWebSocket, \
    ...
    HandlerForActionFromSerial, HandlerForDataFromSerialModelX, HandlerForDataFromSerialModelY
import sys
import socket
...
if __name__ == "__main__":
    ...
    serial_reader.register_handler(HandlerForDataFromSerialModelE(ws_client,
                                                                  ...
                                                                  RobotInfo.robot_id,
                                                                  RobotInfo.server_ip))
    serial_reader.register_handler(HandlerForDataFromSerialModelX(ws_client,
                                                                  serial_client,
                                                                  RobotInfo.robot_id,
                                                                  RobotInfo.server_ip))
    serial_reader.register_handler(HandlerForDataFromSerialModelY(ws_client,
                                                                  serial_client,
                                                                  RobotInfo.robot_id,
                                                                  RobotInfo.server_ip))
